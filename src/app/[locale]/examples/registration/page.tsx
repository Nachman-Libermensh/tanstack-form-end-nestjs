...
import RegistrationForm from "@/features/examples/registration-form";
import { RegistrationFormCode } from "@/features/examples/registration-form-code";
import {
  Card,
  CardContent,
  CardDescription,
...
export default function RegistrationFormExamplePage() {
  const t = useTranslations("examples.registration");
